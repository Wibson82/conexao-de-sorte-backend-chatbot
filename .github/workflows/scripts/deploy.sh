...
# ============================================================================
# 🚀 SCRIPT DE DEPLOY SIMPLIFICADO - CONEXÃO DE SORTE CHATBOT
# ============================================================================
#
...
PROJECT_DIR="/opt/conexao-de-sorte/chatbot"
...
services:
  chatbot:
    image: ghcr.io/\${GITHUB_REPOSITORY:-conexao-de-sorte/conexao-de-sorte-backend-chatbot}-chatbot:\${IMAGE_TAG}
    ports:
      - "8080:8080"
    environment:
