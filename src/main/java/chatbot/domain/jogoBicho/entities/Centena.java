...
@Entity
@Table(name = "tb_centenas")
public class Centena {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;
    
    @Column(name = "centena", nullable = false)
    ...
    public String getCentena() { return centena; }
    public void setCentena(String centena) { this.centena = centena; }
